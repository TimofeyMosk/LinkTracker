...
//	responseRecorder := httptest.NewRecorder()
//
//	bot.On("UpdateSend", int64(12345), "Было обновление : https://example.com/update").Return()
//	bot.On("UpdateSend", int64(67890), "Было обновление : https://example.com/update").Return()
//
//	handler.ServeHTTP(responseRecorder, request)
//
